...
mem load -i {C:/Users/Otrebor Azilab/Desktop/Arch Project/BinstrMem.mem} -format binary /risc_processor/fu/memory/InstMem
...
run
force -freeze sim:/risc_processor/INport 32'h000FFF1E 0
run
force -freeze sim:/risc_processor/INport 32'h0000001E 0
run
run
run
run
